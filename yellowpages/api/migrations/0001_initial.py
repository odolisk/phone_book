    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('personal_phone', models.CharField(blank=True, max_length=17, null=True, unique=True, validators=[django.core.validators.RegexValidator(message='Формат телефонного номера: "+00000000000".Максимум - 15 цифр (+71234567890).', regex='^\\+?1?\\d{8,15}$'), api.validators.UniquePhoneValidator], verbose_name='Личный телефон')),
